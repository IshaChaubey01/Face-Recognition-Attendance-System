...
# Initialize Firebase
cred = credentials.Certificate(r"E:\Professional\Projects\P1\facekey01-firebase-adminsdk-22shp-1033f81808.json")
firebase_admin.initialize_app(cred, {
    'databaseURL': 'https://identifyme-01-default-rtdb.asia-southeast1.firebasedatabase.app/'
})
...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'ishaccc3@gmail.com' ")
...
def TrackImages():
    ...
    if exists1:
        ...
        cv2.destroyAllWindows()
        window.destroy()
        # Initialize attendance with a default value
    attendance = ['Unknown', '', 'Unknown', '', 'Unknown', '', 'Unknown']
    while True:
        ret, im = cam.read()
